...
<div class="course-detail">
	...
	<!-- END: description -->
       ...
       <div class="course-detail-video">
        ...
        <div class="wrappers" id="video-wrapper">
            <div class="containers">
                 <iframe src="https://iframe.mediadelivery.net/embed/242007/{DATA.externalpath}?autoplay=true" loading="lazy" style="border: none;" allowfullscreen="true" allow="accelerometer; gyroscope; autoplay; encrypted-media; picture-in-picture;"></iframe>
            </div>
        </div>
